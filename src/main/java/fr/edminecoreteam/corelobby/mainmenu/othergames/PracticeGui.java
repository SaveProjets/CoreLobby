...
public class PracticeGui implements Listener {
    ...
    public static void gui(Player p) {
        ...
        Inventory inv = Bukkit.createInventory(null, 54, "§8Menu Principal (Practice)");
        ...
        if (settingInfo.getLang() == 0) {
            ItemStack deco = new ItemBuilder(Material.STAINED_GLASS_PANE, 1, (byte) 0)
                    .setName("§r")
            ...
            loreplay.add(" §f▶ §7Joueur(s):  §e" + OnlinesForGroups.getOnlinesFromGroup("practice"));
