        ...
        if (settingInfo.getLang() == 0)
        {
            ...
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    ItemStack paintball = new ItemStack(Material.DIAMOND_SWORD, 1);
                    ItemMeta paintballM = paintball.getItemMeta();
                    paintballM.setDisplayName("§f§lPractice");
                    ArrayList<String> lorepaintball = new ArrayList<String>();
                    lorepaintball.add("");
                    lorepaintball.add(" §aDescription:");
                    lorepaintball.add("");
                    lorepaintball.add(" §dInformations:");
                    lorepaintball.add(" §f▶ §7Joueur(s): §e" + OnlinesForGroups.getOnlinesFromGroup("practice"));
